package com.click369.pedometer.ui.view;
...
public class CircleBar extends View {
	...
	private void init() {
		pedometerDB=PedometerDB.getInstance(getContext());
		...
		mColorWheelPaint.setColor(Color.parseColor("#ff9933"));// 设置颜色
		...
		textPaint1.setColor(Color.parseColor("#ff9933"));
