...
import com.click369.pedometer.ui.activity.SetToTakePicActivity;
import com.click369.pedometer.ui.fragment.tools.PictureUtil;
import com.click369.pedometer.ui.fragment.tools.TimeHelper;
import com.click369.pedometer.ui.fragment.tools.ToRoundBitmap;
/**
 * 设置
...
public class FragmentSet extends Fragment implements OnClickListener {
    ...
    private TextView nameText,nametext2;
    ...
    private void init() {
        ...
        nametext2=	(TextView) view.findViewById(R.id.xingming_name);
        ...
        if (MainActivity.myObjectId != null) {
            ...
            nametext2.setText(user.getName());
            ...
            Step step = new Step();
            // 得到当天的日期
            step.setDate(TimeHelper.gettimeString());
            step.setUserId(MainActivity.myObjectId);
            step.setNumber(0);
            step.setMubiao(10000);
            pedometerDB.saveStep(step);
            Log.i("error", "step.getDate()"+step.getDate()
            		+"step.getUserId()"+step.getUserId());
                ...
                dialog.setPositiveButton("确认",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface arg0, int arg1) {
                                ...
                                nametext2.setText(editText.getText().toString());
