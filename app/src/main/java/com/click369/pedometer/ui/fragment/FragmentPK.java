...
import com.click369.pedometer.ui.fragment.PK.FragmentPK_duo;
import com.click369.pedometer.ui.fragment.PK.FragmentPK_zu;
import com.click369.pedometer.ui.fragment.PK.FragmentPK_add;
import com.click369.pedometer.ui.fragment.tools.DisplayUtil;
/**
 * PK主页
...
public class FragmentPK extends Fragment {
	...
	private void init() {
		...
		fPk_1 = new FragmentPK_duo();
		fPk_2 = new FragmentPK_zu();
