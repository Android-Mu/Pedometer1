package com.click369.pedometer.data.db;
...
public class PedometerDB {
	...
	public void saveStep(Step step) {
		if (step != null) {
			...
			values.put("mubiao", step.getMubiao());
	...
	public void saveWeather(Weather weather) {
		if (weather != null) {
			...
			values.put("date", weather.getPtime());
	...
	public Step loadSteps(String userId, String date) {
		...
		if (cursor.moveToFirst()) {
			do {
				...
				step.setMubiao(cursor.getInt(cursor.getColumnIndex("mubiao")));
